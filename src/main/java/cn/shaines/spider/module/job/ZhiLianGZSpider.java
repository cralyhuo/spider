...
public class ZhiLianGZSpider implements SpiderInterface {
    ...
    private int start = 0;
    // 定义表名
    private String tableName = "智联广州JAVA招聘信息";
    ...
    private Object handlerSalary(){
        ...
        System.out.println("智联广州ava招聘信息共: " + dataList.size() + " 条");
    ...
    private String getHtml(){
        String url = String.format("https://fe-api.zhaopin.com/c/i/sou?start=%d&pageSize=90&cityId=763&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=JAVA&kt=3&rt=134542fe834e4a019404bf10c52124b3&_v=0.04244049&x-zp-page-request-id=6d260c9fff0d4668a158babf5ae396e0-1556345376278-699243", start);
    ...
    public static void main(String[] args) {
        ZhiLianGZSpider zhiLianZSSpider = new ZhiLianGZSpider();
